...
$most_popular_stmnt = $dbh->prepare("select basket_product.PRID, count(basket_product.PRID) as count ,product.name,product.cost,product.DID
                    ...
                    group by basket_product.PRID ,product.name,product.cost,product.DID
                    order by count desc;");

$most_popular_stmnt->execute();
$most_popular = array_slice($most_popular_stmnt->fetchAll(),0,4);

$day_product_stmnt=$dbh->prepare("select top 3 product.PRID,product.name,product.cost,product.DID 
