                ...
                <section class="span8 single single-page">
                    ...
                    <article class="post">
                        <div class="post-inner">
                            <p>
                                کاربر گرامی، تیم آویتا در تلاش شبانه روزی برای ارتقای سطح کیفیت خدمات و محصولات ارائه شده به مشتریان میباشد. تیم پشتیبانی آویتا همه روزه آملده ی خدمات رسانی و رسیدگی به درخواست های کاربران است ، امید است با ارائه نظرات ، پیشنهادات و انتقادات خود مارا در نیل به این هدف یاری نمایید.
                            </p>
                        </div>
                    </article>
