...
CREATE TABLE basket_product(BID INT NOT NULL,CONSTRAINT fk_bp_basket FOREIGN KEY (BID) REFERENCES basket(BID),PRID INT NOT NULL,CONSTRAINT fk_bp_product FOREIGN KEY (PRID) REFERENCES product(PRID),PRIMARY KEY (BID,PRID));
